# -*- coding: utf-8 -*-
"""
Created on Sat Sep 10 15:43:10 2022
...
import nasdaq
import sp500sectors
from subsector_marketsize_Quarter import Subsector_Growth_Quarter as SG_Q
...
print("sp ..")   
sp_growth_Quarter = Subsector_Growth_view().subsector_growth_sp()

'''
print("nasdaq ..")
nasdaq_growth_Quarter = Subsector_Growth_view().subsector_growth_nas()
print("Dow ..")
dow_growth_Quarter = Subsector_Growth_view().subsector_growth_dow()
'''