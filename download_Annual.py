...
class Accounting_Info_Annual:
    ...
    def getIncomeStatements(self,symbol_name):
        url_incomeStatement= "https://financialmodelingprep.com/api/v3/income-statement/"+symbol_name+"?limit=120&apikey="+"2b2bbacbc149bcba58903f591ae3d3c8"
    ...
    def getAnnualBalanceSheet(self, symbol_name):
        url_balanceSheet = "https://financialmodelingprep.com/api/v3/balance-sheet-statement/"+symbol_name+"?limit=120&apikey="+"2b2bbacbc149bcba58903f591ae3d3c8"
    ...
    def getAnnualCashFlow(self,symbol_name):
        url_cash_flow = "https://financialmodelingprep.com/api/v3/cash-flow-statement/"+symbol_name+"?limit=120&apikey="+"2b2bbacbc149bcba58903f591ae3d3c8"
    ...
    def getEV(self, symbol_name):
        url_ev = "https://financialmodelingprep.com/api/v3/enterprise-values/"+symbol_name+"?limit=120&apikey="+"2b2bbacbc149bcba58903f591ae3d3c8"
