        ...
        for index in range(df_length+1):          
            if i==df_length:
                if df_income["revenue"][index]!=0:
                    ...
                    date = df_income["date"][index]
                    dic = {"Symbol":symbol_name,"Date":str(date),"operatingIncome_Growth_Percant":growth_percent, "operatingIncome_Growth":growth}
...
#netProfit = Find_Growth_Annual().netProfit_margin_growth("AAPL")
#operatingProfit = Find_Growth_Annual().operating_margin_growth("AAPL")
#grossProfit = Find_Growth_Annual().gross_margin_growth("AAPL")
#epsProfit = Find_Growth_Annual().eps_margin_growth("AAPL")